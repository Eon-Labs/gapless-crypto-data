...
class RegressionDetector:
    ...
    def __init__(self,
        ...
        self.numerical_features = ['open', 'high', 'low', 'close', 'volume',
    ...
    def detect_data_drift(self,
        ...
        try:
            ...
            available_cols = [col for col in self.numerical_features
        ...
        try:
            ...
            if all(col in data.columns for col in price_cols):
                ...
                quality_results['price_consistency'] = all([
                    high_low_valid, high_open_valid, high_close_valid,
...
class DataQualityMonitor:
    ...
    def monitor_dataset(self, data: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            high_alerts = [alert for alert in monitoring_results['alerts'] if alert['severity'] == 'HIGH']
            if high_alerts:
