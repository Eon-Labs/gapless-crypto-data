...
from gapless_crypto_data.regression import RegressionDetector, DataQualityMonitor
...
class TestRegressionDetector:
    ...
    def create_ohlcv_data(self, rows: int = 100,
                         start_date: str = "2024-01-01",
                         add_anomalies: bool = False,
                         drift_factor: float = 1.0) -> pd.DataFrame:
...
class TestDataQualityMonitor:
    ...
    def test_monitor_dataset_critical_issues(self):
        ...
        quality_alerts = [alert for alert in result['alerts']
